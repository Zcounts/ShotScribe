...
export const DEFAULT_SCRIPT_DOCUMENT_SETTINGS = {
  ...
  blockStyles: {
    ...
    character: { ...defaultBlock, marginLeftPx: 2.6 * 96, marginRightPx: 1.4 * 96, align: 'center' },
    parenthetical: { ...defaultBlock, marginLeftPx: 1.8 * 96, marginRightPx: 2.2 * 96 },
    dialogue: { ...defaultBlock, marginLeftPx: 1 * 96, marginRightPx: 1.5 * 96 },
    transition: { ...defaultBlock, marginLeftPx: 4.5 * 96, align: 'right' },
